public class TextAnalysis {                     //opprette klassen TextAnalysis
    private int[] numberLetter = new int[30];   //array, A-Å, + tegn som ikke er bokstaver

    public TextAnalysis(String text) {          //konstruktør, parameter "String".
    ...
    public String findCommonLetter() {                   //metode for å finne den mest brukte bokstaven
